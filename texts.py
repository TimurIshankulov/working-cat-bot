...
FOOD_FISH_ACQUIRED = 'Поздравляем! Вы покормили своего кота ' + SYMBOL_FISH + ' рыбкой и получили постоянный бонус + 10% к скорости выполнения заданий!'
FOOD_FISH_DESC = SYMBOL_FISH + ' Рыбка (' + SYMBOL_COINS + ' 100)'
FOOD_PREMIUM_ACQUIRED = 'Поздравляем! Вы покормили своего кота ' + SYMBOL_PREMIUM + ' премиум-кормом и получили постоянный бонус + 20% к скорости выполнения заданий!'
FOOD_PREMIUM_DESC = SYMBOL_PREMIUM + ' Премиум-корм (' + SYMBOL_COINS + ' 200)'
FOOD_SHRIMP_ACQUIRED = 'Поздравляем! Вы покормили своего кота ' + SYMBOL_SHRIMP + ' королевской креветкой и получили постоянный бонус + 30% к скорости выполнения заданий!'

...
GREETING_1 = 'Приветствую тебя! Назовите имя своего ' + SYMBOL_CAT + ' ленивого кота, который не хочет работать:'
GREETING_2 = 'Имя Вашего ' + SYMBOL_CAT + ' питомца: {0}.\n\
...
' бонусы.\nПриобретите ' + SYMBOL_HOUSE + ' особняк, чтобы Ваш ' + SYMBOL_CAT + \
' котик ни в чем себе не отказывал!\n' + SYMBOL_ATTENTION + 'Примечание. Новые возможности \
открываются с ростом ' + SYMBOL_LEVEL + ' уровня ' + SYMBOL_CAT + ' котика.'
...
MESSAGE_WORK = 'работа'
MESSAGE_TOYS = 'игрушки'
MESSAGE_FOOD = 'корм'
MESSAGE_HOMES = 'дома'
MESSAGE_TREASURE_HUNT = 'поиск сокровищ'
MESSAGE_TROPHIES = 'трофеи'
MESSAGE_CAT_COMMITTEE = 'котовский комитет'
MESSAGE_CAT_VACATION = 'котик в отпуске'
MESSAGE_CAT_COMMITTEE_STATUS = 'статус комитета'
MESSAGE_DONATE_COINS = 'пожертвовать монеты'
MESSAGE_RATING_EXPERIENCE = 'рейтинг по опыту'
MESSAGE_RATING_COINS = 'рейтинг по монетам'
MESSAGE_BACK = 'назад'
...
собой, это великое достижение для ' + SYMBOL_CAT + ' котика!'
...
CAT_COMMITTEE_DONATE_SATELLITE = SYMBOL_SATELLITE + ' Спутник (' + SYMBOL_COINS + ' 2000)'
